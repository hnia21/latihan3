...
DROP POLICY IF EXISTS "Auth read articles" ON articles;
...
DROP POLICY IF EXISTS "Auth read karya" ON karya;
...
CREATE POLICY "Auth read karya" ON karya FOR SELECT TO authenticated USING (true);
